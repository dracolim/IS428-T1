...
var t = function (a, b) {
    ...
    percentagedata = d3.layout.partition().sort(null).size([2 * Math.PI, rad]).children(function (a) {
        return a.value instanceof Array ?
            (a._percentage = a.value, d3.entries([a.value[a.value.length - 1]])) :
            (a._percentage = u(a.value), isNaN(a.value) ? d3.entries(a.value) : null)
    })
    .value(function (a) {
        return a.value
    }),
